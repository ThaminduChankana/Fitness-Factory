						...
						<Col>
							<Link to="/admin-leave-report">
									<Button variant="success" style={{ marginLeft: 190, fontSize: 15,marginTop:10 }} size="lg">
										Trainer Leave Details conformation Report
									</Button>
								</Link>
							</Col>
					</Row>
									...
									<Accordion>
										...
										>
											...
											>
												...
												<div>
												<Button style={{ marginLeft: 20, float: "left", fontSize: 18, marginTop:15}} href={`trainer/trainer_leaves/approve/${trainerLeaveList._id}`}>Approve</Button>
