...
import './trainerUpdateLeave.css'
 ...
 export default function TrainerUpdateLeave ({match}) {
    ...
    const updateHandler =  (e) => {
		...
		if (!fullName||!nic||!division||!number_of_days||!date_for_commencing_leave||!date_for_resuming_duties||!reasons_for_leave)return;
	...
	if (trainerInfo) {
		return (
			<div className="leaveeditBg">
				<br></br>
				<MainScreen title="TRAINER UPDATE DETAILS">
					<Button
						variant="success"
						style={{
							float: "left",
